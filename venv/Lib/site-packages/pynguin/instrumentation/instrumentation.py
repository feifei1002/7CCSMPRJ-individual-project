...
class BranchCoverageInstrumentation(InstrumentationAdapter):
    ...
    def _instrument_bool_based_conditional_jump(
        ...
        We add a call to the tracer which report the value on which the conditional
        jump will be based.
    ...
    def _instrument_compare_based_conditional_jump(
        ...
        We add a call to the tracer which report the values that will be used
...
class LineCoverageInstrumentation(InstrumentationAdapter):
    ...
    def instrument_line(
        ...
        We add a call to the tracer which report a line was executed.
